...
tableDiv.appendChild(table);  //add table to premade table div in the html

table.setAttribute("id", "mainTable");
table.setAttribute("border", 1);

document.getElementById("RowColSubmit").onclick = RowColSubmit;    //create table on button press
...
function addData(e) {                           //Function to add data in the corresponding date cell
...
function viewData(e) {                        //View the number of events added on that date cell
  lnk = e.srcElement.parentNode;
